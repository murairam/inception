*This project has been created as part of the 42 curriculum by murairam*

# Inception

![42 Score](https://img.shields.io/badge/Score-113%2F100-brightgreen?style=for-the-badge&logo=42&logoColor=white)
![Bonus](https://img.shields.io/badge/Bonus-All%20Complete-success?style=for-the-badge)
...
| **Security** | Low - easily exposed | High - encrypted and secure | Secrets |
...
| **Portability** | More portable across systems | Path must exist on host | Trade-off |
...
| **Permissions** | Docker manages | Manual setup required | Trade-off |
